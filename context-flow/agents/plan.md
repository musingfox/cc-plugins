...
1. **Decisions first, contracts second**: Identify the key design decisions and their alternatives before defining contracts. Each contract is the consequence of a decision.
